...
pulumi.export(
    "Custom Model ID " + agent_langgraph_resource_name, agent_langgraph_custom_model.id
)


agent_langgraph_agent_deployment_id = "None"
if os.environ.get("DEPLOY") != "0":
    ...
    agent_langgraph_agent_deployment_id = str(agent_langgraph_agent_deployment.id)
    ...
    pulumi.export(
        "Agent Chat Completion Endpoint " + agent_langgraph_resource_name,
